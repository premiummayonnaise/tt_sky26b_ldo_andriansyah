...
C {sky130_fd_pr/corner.sym} 1210 -150 0 0 {name=CORNER only_toplevel=true corner=ss}
C {code_shown.sym} 1370 -600 0 0 {name=s1 only_toplevel=false value="
...
C {isource.sym} 1260 -360 0 0 {name=I1 value=4m}
C {lab_pin.sym} 1260 -300 0 0 {name=p14 sig_type=std_logic lab=VSS}
...
C {lab_pin.sym} 550 -460 0 0 {name=p35 sig_type=std_logic lab=VBIAS}
...
C {vsource.sym} 270 -310 0 0 {name=V6 value=0.9 savecurrent=false}
C {lab_pin.sym} 270 -280 0 0 {name=p37 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 270 -340 0 0 {name=p38 sig_type=std_logic lab=VBIAS}
