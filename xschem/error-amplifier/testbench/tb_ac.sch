...
N 440 -790 500 -790 {lab=VDD3}
N 440 -810 500 -810 {lab=IBIAS3}
N 440 -940 500 -940 {lab=VDD2}
N 440 -960 500 -960 {lab=IBIAS2}
N 440 -1090 500 -1090 {lab=VDD1}
N 440 -1110 500 -1110 {lab=IBIAS1}
...
C {/foss/designs/2026/tt_sky26b_ldo_andriansyah/xschem/bias-net/schematics/bias-network.sym} 290 -790 0 0 {name=x4}
C {lab_pin.sym} 440 -830 0 1 {name=p41 sig_type=std_logic lab=VDD3}
C {lab_pin.sym} 440 -750 0 1 {name=p42 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 440 -770 0 1 {name=p43 sig_type=std_logic lab=VREF3}
C {lab_pin.sym} 500 -790 0 1 {name=p44 sig_type=std_logic lab=VDD3}
C {lab_pin.sym} 500 -810 0 1 {name=p45 sig_type=std_logic lab=IBIAS3}
C {/foss/designs/2026/tt_sky26b_ldo_andriansyah/xschem/bias-net/schematics/bias-network.sym} 290 -940 0 0 {name=x5}
C {lab_pin.sym} 440 -980 0 1 {name=p46 sig_type=std_logic lab=VDD2}
C {lab_pin.sym} 440 -900 0 1 {name=p47 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 440 -920 0 1 {name=p48 sig_type=std_logic lab=VREF2}
C {lab_pin.sym} 500 -940 0 1 {name=p49 sig_type=std_logic lab=VDD2}
C {lab_pin.sym} 500 -960 0 1 {name=p50 sig_type=std_logic lab=IBIAS2}
C {/foss/designs/2026/tt_sky26b_ldo_andriansyah/xschem/bias-net/schematics/bias-network.sym} 290 -1090 0 0 {name=x6}
C {lab_pin.sym} 440 -1130 0 1 {name=p51 sig_type=std_logic lab=VDD1}
C {lab_pin.sym} 440 -1050 0 1 {name=p52 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 440 -1070 0 1 {name=p53 sig_type=std_logic lab=VREF1}
C {lab_pin.sym} 500 -1090 0 1 {name=p54 sig_type=std_logic lab=VDD1}
C {lab_pin.sym} 500 -1110 0 1 {name=p55 sig_type=std_logic lab=IBIAS1}
