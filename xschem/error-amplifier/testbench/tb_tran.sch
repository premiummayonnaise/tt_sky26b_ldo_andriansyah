...
C {lab_pin.sym} 620 -170 0 1 {name=p5 lab=IBIAS}
C {lab_pin.sym} 620 -110 0 0 {name=p7 sig_type=std_logic lab=VSS}
C {isource.sym} 620 -140 0 0 {name=I4 value="2.5u" savecurrent=false}
