...
N 200 -490 220 -490 {lab=VDD}
N 200 -400 220 -400 {lab=VDD}
N 200 -310 220 -310 {lab=VDD}
N 220 -460 220 -430 {lab=#net8}
N 220 -370 220 -340 {lab=#net9}
N 220 -280 220 -250 {lab=#net10}
N 260 -310 260 -260 {lab=#net10}
N 220 -260 260 -260 {lab=#net10}
N 260 -400 260 -350 {lab=#net9}
N 220 -350 260 -350 {lab=#net9}
N 260 -490 260 -440 {lab=#net8}
N 220 -440 260 -440 {lab=#net8}
N 220 -600 220 -550 {lab=VDD}
N 220 -610 220 -600 {lab=VDD}
N 620 -420 620 -390 {lab=#net11}
N 450 -420 450 -390 {lab=#net12}
N 530 -490 530 -400 {lab=#net1}
N 220 -550 220 -520 {lab=VDD}
N 620 -610 740 -610 {lab=VDD}
N 580 -580 700 -580 {lab=#net2}
N 290 -180 290 -170 {lab=#net7}
N 220 -180 290 -180 {lab=#net7}
...
.endc
"}
C {vsource.sym} 1470 -310 0 0 {name=V5 value=1.8 savecurrent=false}
...
C {sky130_fd_pr/pfet_01v8.sym} 240 -490 0 1 {name=M9
W=1
L=0.4
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 240 -400 0 1 {name=M10
W=1
L=0.4
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 240 -310 0 1 {name=M11
W=1
L=0.4
nf=1
mult=1
...
C {lab_pin.sym} 200 -490 0 0 {name=p12 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 200 -400 0 0 {name=p13 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 200 -310 0 0 {name=p14 sig_type=std_logic lab=VDD}
